...
---------------------------------------------------------------------------------------------------------------------                                                                                                                                                                                                                                                                                                                           
RINKEBY CNFT (V4: CODENAME "XFO")
"XFO"                       :   Creator Shared NFT Media Contract for Catalog Records Inc.
@author                     :   @bretth18 (computerdata) of @catalogworks
@title                      :   XFO
@dev                        :   Upgradeable ERC721 Contract. Final proposed implementation (XFO), Rinkeby.
                                Purpose built for optmization over the Zora V1 contracts.
                                Code relies on implementations thanks to @ isian (iain nash) of Zora. 
---------------------------------------------------------------------------------------------------------------------                                                                                                                                                                                                                                                                                                                           
 */
contract XFO is ERC721Upgradeable, IERC2981Upgradeable, OwnableUpgradeable {
