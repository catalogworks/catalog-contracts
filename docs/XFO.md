...
-------------------------------------------------------------------------------------------------------------------- XFO************************************************ LEGAL DISCLAIMER: https://catalog.works/terms************************************************ ---------------------------------------------------------------------------------------------------------------------                                                                                                                                                                                                                                                                                                                            RINKEBY CNFT (V4: CODENAME &quot;XFO&quot;) &quot;XFO&quot;                       :   Creator Shared NFT Media Contract for Catalog Records Inc.

*:   Upgradeable ERC721 Contract. Final proposed implementation (XFO), Rinkeby. Purpose built for optmization over the Zora V1 contracts. isian (iain nash) of Zora.  ---------------------------------------------------------------------------------------------------------------------                                                                                                                                                                                                                                                                                                                           *
...
```solidity
function mint(XFO.TokenData _data, bytes32[] _proof) external nonpayable returns (uint256)
```
...
| Name | Type | Description |
|---|---|---|
| _data | XFO.TokenData | TokenData struct, see ITB303
